...
export default function RunnerProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // DUAL SAVE: Backend first - Create Racer (schema will generate racerId)
      const res = await axiosInstance.post('/api/racers', {
        email: auth.currentUser?.email,
        firstName: name.split(' ')[0],
        lastName: name.split(' ').slice(1).join(' '),
        age: parseInt(age),
        phone: null, // Optional
        firebaseId: auth.currentUser?.uid // Firebase UID for auth lookup
      });
      ...
      // DUAL SAVE: Then localStorage - Store the generated racerId and profile data
      localStorage.setItem('racerId', res.data.racerId); // Use the generated racerId from backend
      localStorage.setItem('runnerProfile', JSON.stringify({
        racerId: res.data.racerId, // Generated by schema
        name,
        goesBy,
        age: parseInt(age),
        city,
